...
<head>
    ...
    <style>
        ...
        body{
            background-image: url('/servis/gambar/Template.png');
            ...
            <tr>
                <th><form action="" method="GET">
                        <div class="input-group mb-3">
                            <input type="text" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control ngisi" placeholder="Input Service Number...">
                            <button type="submit" id="button-addon1" class='btn baten btn-dark'>Search</button>
                        </div>
                    </form>
                </th>
                <th><a class='mb-3 btn btn-dark btn-sm bottom-0 end-0 p-2 baten' href='/servis/isi-data.php'>Tambahkan Data</a></th>
                <th><a class='mb-3 btn btn-dark btn-sm bottom-0 end-0 p-2 baten' href='/servis/laptop.php'>Database Laptop</a></th>
            </tr>
        </thead>
    </table>
    </div>
                    ...
                    <tbody>
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class='btn btn-primary btn-sm' href='/servis/edit-servis.php?ID_Cust=$row[ID_Cust]'>Edit</a>
                                    <a class='btn btn-danger btn-sm' href='/servis/delete-servis.php?ID_Cust=$row[ID_Cust]&No_Servis=$row[No_Servis]'>Delete</a>
                                ...
                                <ul class='dropdown-menu'>
                                  ...
                                  <li><a class='dropdown-item' href='#'>Edit Bill</a></li>
                                  <li><a class='dropdown-item' href='#'>Show Bil</a></li>
                                </ul>
                              </div>
                              </td>
                            </tr>
